...
func NewHandler(l *log.Logger, r *repository.ProfileRepository) (*ProfileHandler, error) {
	return &ProfileHandler{l, r}, nil
}

func (*ProfileHandler) CreateUser(w http.ResponseWriter, req *http.Request) {
